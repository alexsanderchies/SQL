...
and  a.dt_atendimento between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                          and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
...
Count(lei.cd_solic_transferencia_leito)
 ...
 WHERE lei.dt_solic_transf between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                          and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
...
and  a.dt_atendimento between to_date('07.07.2023 00:01:00', 'dd/mm/yyyy HH24:MI:SS')
                          and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
...
--and a.nm_usuario not in 'DBAMV'
and  a.dt_alta between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                          and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
...
where  tri.dh_senha between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                          and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
...
count (cd_SOLIC_LIMPEZA) Realizado
 ...
 where   DT_realizado between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                          and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
...
and ec.tp_escala = 'A'
and  i.hr_agenda between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                          and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
...
AND b.tp_situacao = 'A'
--AND A.NM_USUARIO NOT IN 'DBAMV'
and b.dt_aviso_cirurgia between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                          and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
...
'Documentos Clinicos' tipo,
 ...
 WHERE Pec.Cd_Documento_Clinico    = Pdc.Cd_Documento_Clinico
   ...
   and pdc.dh_fechamento between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                          and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
...
and c.dt_pre_med between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                          and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
...
AND tp_pre_med = 'M'
--AND A.NM_USUARIO NOT IN 'DBAMV'
and a.dh_criacao between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                          and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
...
and pa.dh_avaliacao between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                          and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
...
and sv.data_coleta between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                          and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
...
WHERE tec.dt_evo_enf between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                          and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
...
AND bh.dt_referencia between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                         and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
...
count (SAC.CD_CLASSIFICACAO_RISCO) Realizado
 ...
 from  DBAMV.SACR_CLASSIFICACAO_RISCO SAC
  where sac.dh_classificacao_risco between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                          and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
...
FROM DBAMV.hritpre_cons chec
  where chec.dh_checagem between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                          and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
/*
UNION ALL
...
and d.dt_pedido between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                          and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
...
and lr.dt_laudo between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                          and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
...
and i.dt_laudo between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                          and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
...
and t.dt_solsai_pro between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                          and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
...
and p.dt_entrada between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                          and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
...
and k.dt_mvto_estoque between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                          and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
...
count (s.cd_ent_serv) Realizado
 ...
 where s.dt_entrada between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                          and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
...
and p.dt_entrada between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
 ...
 SELECT
    ...
    FROM DBAMV.ORD_COM
          WHERE dt_ord_com between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                               and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
    ...
    FROM DBAMV.sol_com
          WHERE dt_sol_com between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                               and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:mi:ss')
...
and   rf.sn_fechada = 'S'
and rf.dt_fechamento between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                          and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
...
and reg.dt_fechamento between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                          and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
...
count (G.CD_GUIA) Realizado
 ...
 and g.tp_guia <> 'C'
 and g.tp_situacao = 'A'
 and g.dt_autorizacao between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                          and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
...
and re.dt_fechamento between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                          and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
...
count (re.cd_remessa) Realizado
 ...
 --ds_remessa like 'BPA%'
 --AND
  re.dt_competencia_apresentacao between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                          and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
...
count (re.cd_remessa) Realizado
 ...
 where  re.dt_fechamento between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                          and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
...
where a.dt_envio between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                          and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
...
UNION ALL
  ...
  SELECT
     ...
     'Contas a pagar' tipo,
      ...
      FROM con_pag
     WHERE dt_lancamento between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                          and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
...
UNION ALL
  ...
  SELECT
     ...
     'Contas a receber' tipo,
      ...
      FROM con_rec
     WHERE dt_emissao between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                          and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
     ...
     'Movimentação do CAIXA' tipo,
      ...
      FROM MOV_CAIXA
     WHERE dt_MOVIMENTACAO between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                          and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
...
UNION ALL
     ...
     'Lançamentos Contabeis' tipo,
      ...
      FROM lcto_contabil
     WHERE dt_integra between to_date('07.07.2023 00:00:00', 'dd/mm/yyyy HH24:MI:SS')
                          and to_date('31.07.2023 23:59:00', 'dd/mm/yyyy HH24:MI:SS')
